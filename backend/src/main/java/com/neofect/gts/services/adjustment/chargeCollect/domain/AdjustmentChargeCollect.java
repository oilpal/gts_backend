package com.neofect.gts.services.adjustment.chargeCollect.domain;
...
// GS01080
@Alias("AdjustmentChargeCollect")
@Data
public class AdjustmentChargeCollect implements Serializable {
